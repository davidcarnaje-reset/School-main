      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-800 tracking-tight flex items-center gap-2">
            <AlertCircle className="text-blue-600" size={32} style={{ color: themeColor }} />
        ...
        <button 
          onClick={() => alert("Create incident log coming soon.")}
        ...
        <div className="space-y-4">
          {infractions.length === 0 ? (
            <div className="py-12 text-center text-slate-400 font-bold text-xs uppercase tracking-wider">
              No conduct infractions or disciplinary logs registered.
            </div>
          ) : (
              ...
              <div key={i} className="p-4 border border-slate-100 rounded-2xl bg-slate-50/50 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-555 mt-1 font-semibold">Incident: <span className="text-slate-700 font-bold">"{inf.incident}"</span></p>
