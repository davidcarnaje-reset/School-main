  ...
  try {
    ...
    const studentSql = `
      INSERT INTO students (
        ...
        place_of_birth, religion, address_house, address_brgy, address_city, address_province, address_zip,
        father_name, father_first_name, father_middle_name, father_last_name, father_occ, father_contact,
        mother_name, mother_first_name, mother_middle_name, mother_last_name, mother_occ, mother_contact,
        guardian_name, guardian_first_name, guardian_middle_name, guardian_last_name, guardian_occ, guardian_contact, guardian_rel, guardian_address,
